...
$LANG['plugin_mreporting']['Helpdeskplus'] = [
   ...
   'reportGlineBacklogs' => [
      'title'    => "Backlog",
      'desc'     => "Ce rapport affiche le nombre de tickets groupés sur la période selectionnée (jour, semaine, ...).<br>".
   ...
   'reportVstackbarTicketstech' => [
      'title'    => "Quantitatif par techniciens",
   ...
   'reportHbarTopcategory' => [
      ...
      'desc'     => "Nombre croissant de tickets affiché par catégories. <br>".
   ...
   'reportHbarTopapplicant' => [
      ...
      'desc'     => "Nombre croissant de tickets affiché par groupes demandeur. <br>".
                    "Il est possible limiter le nombre de groupes affichés !",
      'category' => "Général",
   ],

   'reportVstackbarGroupChange' => [
      'title'    => "Nombre de changements de groupe",
