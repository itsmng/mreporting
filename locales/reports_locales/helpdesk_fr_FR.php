...
$LANG['plugin_mreporting']['Helpdesk'] = [
   ...
   'reportHbarTicketNumberByEntity' => [
      'title'    => "Nombre de tickets par entités",
      'desc'     => "Barres",
   ...
   'reportHgbarTicketNumberByCatAndEntity' => [
      'title'    => "Nombre de tickets par catégories et entités",
   ...
   'reportAreaNbTicket' => [
      'title'    => "Evolution du nombre de tickets sur la période",
      'desc'     => "Aire",
      'category' => "Par tickets",
   ],
   ...
   'reportGlineNbTicket' => [
      'title'    => "Evolution du nombre de tickets sur la période (par Statut)",
      'desc'     => "Lignes",
      'category' => "Par tickets",
   ],
   ...
   'reportHbarTicketNumberByLocation' => [
      'title'    => "Nombre de tickets par lieu des demandeurs",
      'desc'     => "Barres",
      'category' => "Par demandeurs",
   ],
